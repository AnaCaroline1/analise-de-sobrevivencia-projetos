...
Para comparação, se utiliza os pacotes implementados do $R$ para aplicar análise de sobrevivência com o $survival$, vizualização gráfica e leitura de banco de dados com $readxl$.
...
1.  *pacientes com câncer de bexiga*[^1]

[^1]: Base retirada do repositório dos autores do livro Análise de Sobrevivência, Colossimo & Giolo: [Acesse aqui](https://docs.ufpr.br/~giolo/asa/Dados.html);
