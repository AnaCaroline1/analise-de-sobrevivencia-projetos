...
$$
= \left[\frac{1}{\alpha} \cdot exp\left[-\frac{t_{i}}{\alpha}\right]\right]^{\delta_{i}} \cdot \left[exp\left[-\frac{t_{i}}{\alpha}\right]\right]^{1-\delta_{i}}
$$
...
# Verificanco com o banco de Síndrome Gripal

tempo_sg <- day(ymd(df_srag_sg$dt_sin_pri))
status_sg1 <- df_srag_sg$status_1

ajust1_sg <- survreg(Surv(tempo_sg,status_sg1)~1,dist = "exponential")
