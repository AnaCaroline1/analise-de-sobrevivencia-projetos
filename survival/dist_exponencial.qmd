...
## Função de verossimilhança# Distribuição Exponencial
...
$$
L(\theta | t) = \prod_{i=1}^{n} \left[ \left( \frac{1}{\alpha} \exp \left[ -\left( \frac{t_{i}}{\alpha} \right) \right] \right)^{\delta_{i}} \cdot \left( \exp \left[ -\left( \frac{t_{i}}{\alpha} \right) \right] \right)^{1-\delta_{i}} \right] = \\[10pt]
